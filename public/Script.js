...
async function saveAsPDF() {
  try {
    ...
    // Clone the SVG container for the front side
    const svgCloneFront = svgContainer.cloneNode(true);
    const svgElementFront = svgCloneFront.querySelector('svg');
    svgElementFront.style.marginLeft = '0';
    svgElementFront.style.alignSelf = 'flex-start'; // Align to the left    
    svgElementFront.style.borderRadius = '20px';
    svgElementFront.style.height = '10cm'; 
    ...
    // Clone the SVG container for the reverse side and flip it
    const svgCloneReverse = svgContainer.cloneNode(true);
    svgCloneReverse.style.transform = 'scaleX(-1)'; // Flip horizontally
    const svgElementReverse = svgCloneReverse.querySelector('svg');
    svgElementReverse.style.height = '10cm';  // Constrain height to 13cm
    svgElementReverse.style.margin = '0';
    svgElementReverse.style.alignSelf = 'flex-start'; // Align to the left
    svgElementReverse.style.borderRadius = '20px';
    svgElementReverse.style.transform = 'scaleX(-1)'; // Flip horizontally
